...
from data import ClassDataLoader, ClassMemDataLoader, MultiEpochsDataLoader, ClassPartMemDataLoader
...
if __name__ == '__main__':
    ...
    # multi-process of ImageNet-100
    # tune the following only if using multi-process
    parser.add_argument("--phase", type=int)
    parser.add_argument("--nclass_sub", type=int)
    ...
    args.save_dir = os.path.join(args.results_path, DATANAME, "IPC"+str(args.ipc), "phase_{}".format(args.phase))
